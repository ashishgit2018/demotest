...
Feature: Test JMeter
  ...
  Scenario: Test a GET Request
    Given Set JMeter No of threads as "2", No of loops as "2" and Ramp up as "1"
    And Set JMeter test domain as "https://google.com", port as "443" and Http method as "GET"
